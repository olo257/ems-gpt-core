...
class WebUiContractTests(unittest.TestCase):
    ...
    def test_module_tiles_are_stable_and_only_text_is_refreshed(self):
        ...
        self.assertIn("tile.value.textContent=displayStatus(status)", HTML)
        self.assertIn("RUNNING:'URUCHOMIONY'", HTML)
        self.assertIn("STARTING:'STARTUJE'", HTML)
        self.assertIn("LIVE:'URUCHOMIONE'", HTML)
        self.assertIn("OFF:'WYŁĄCZONY'", HTML)
        self.assertIn("DISABLED:'WYŁĄCZONY'", HTML)
